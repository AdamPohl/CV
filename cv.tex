...
Visual basic programing for OR, Analysis, Computing for Maths (Python and
Sagemath).
...
\begin{itemize}
\item After a strong performance in this course, the module leader specifically
    chose me to act as a tutor. This involved the teaching of Python and
    Sagemath to subsequent first year students.
\end{itemize}
...
\vspace{8pt}
\begin{itemize}
\item \textbf{Communication and Interpersonal skills} \\
    These skills are evidenced by my work in retail (TK Maxx): I regularly give
